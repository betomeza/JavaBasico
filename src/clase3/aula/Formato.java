...
public class Formato {
    ...
    public static void main(String[] args) {
        try {
            ...
            //Formato.getFormatoNumero();
            //Formato.getFormatoFecha();
            //Formato.getSimpleDate();
            //Formato.comparaFechas();
            Formato.textToDate();
        } catch (ParseException ex) {
            System.out.println("ERROR");
        }
        
        System.out.println(Utiles.stringToDate("aaaa/08/2013"));
    }

    public static void textToDate() throws ParseException{
        DateFormat dateFormat = DateFormat.getDateInstance();
        
        Date fecha = dateFormat.parse("asdasdsadsd/08/2013");
    ...
    public static void getFormatoNumero() {
        ...
        // separador decimal.
        NumberFormat numberUS = NumberFormat.getInstance(Locale.US);

        // Agrupar 
        numberUS.setGroupingUsed(true);
        System.out.println(numberUS.format(10000000.0045451));

        // No agrupar
        numberUS.setGroupingUsed(false);
        System.out.println(numberUS.format(10000000.0045451));

        System.out.println("Con 3 enteros mínimo");
        numberUS.setMinimumIntegerDigits(3);
        System.out.println(numberUS.format(12));

        System.out.println("Con 5 enteros máximo");
        numberUS.setMaximumIntegerDigits(5);
        System.out.println(numberUS.format(123456));

        System.out.println("Con 4 enteros máximo en los decimales");
        numberUS.setMaximumFractionDigits(4);
        System.out.println(numberUS.format(123.981454));

        System.out.println("Con 2 enteros mínimo en los decimales");
        numberUS.setMinimumFractionDigits(2);
        System.out.println(numberUS.format(45.2));
    ...
    public static void comparaFechas() {
